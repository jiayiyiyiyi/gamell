...
var StarLayer = cc.Layer.extend({
  ...
  comCon : function(){
    ...
    this.shapeZero = cc.Sprite.create(res.BlackStar);
    this.shapeZero.setAnchorPoint(0, 0);
    this.shapeZero.setPosition((548-36)*fix,h2);
    this.shapeZero.setScale(0.333*fix);
    this.addChild(this.shapeZero, 5);

    this.shapeOne = cc.Sprite.create(res.BlackStar);
    this.shapeOne.setAnchorPoint(0, 0);
    this.shapeOne.setPosition((584-36)*fix,h2);
    ...
    this.starArr = [this.shapeZero,this.shapeOne,this.shapeTwo,this.shapeThree,this.shapeFour,this.shapeFive];
  },
