...
var StarLayer = cc.Layer.extend({
  ...
  comCon : function(){
    ...
    this.shapeFour.setPosition(479*fix,h2);
    ...
    this.shapeFive.setPosition(515*fix,h2);
    ...
    this.shapeSix.setPosition(551*fix,h2);
    this.shapeSix.setScale(0.333*fix);
    this.addChild(this.shapeSix, 5);

    this.shapeSeven = cc.Sprite.create(res.BlackStar);
    this.shapeSeven.setAnchorPoint(0, 0);
    this.shapeSeven.setPosition(587*fix,h2);
    this.shapeSeven.setScale(0.333*fix);
    this.addChild(this.shapeSeven, 5);

    this.shapeEight = cc.Sprite.create(res.BlackStar);
    this.shapeEight.setAnchorPoint(0, 0);
    this.shapeEight.setPosition(623*fix,h2);
    this.shapeEight.setScale(0.333*fix);
    this.addChild(this.shapeEight, 5);
    
    this.starArr = [this.shapeFour,this.shapeFive,this.shapeSix,this.shapeSeven,this.shapeEight]
  },
  ...
  gameEnd:function(num){
    ...
    for(var n=0;n<this.starArr.length;n++){
      ...
      this.ok.setPosition(size.width/2,size.height/414*20);
    ...
    countTime: function () {
        ...
        App.report(updata)
        updata = {
            task_id: '4793d5d87a2f4a5b8f546f31cd33f12c',
            is_finish: 0,
            finish_star: 0,
            finish_steps: 0,
            finish_time: 0,
